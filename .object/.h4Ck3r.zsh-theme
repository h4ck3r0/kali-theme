...
# └─╼ ❯❯❯
PROMPT="
%F{\${ARCHIFY_PRIMARY}}┌─%F{\${ARCHIFY_PRIMARY}}[%F{\${ARCHIFY_PRIMARY}}%B\${SHELL_NAME:-H4CK3R}%b%F{white}㉿%B%F{\${ARCHIFY_SECONDARY}}KALI%b%F{\${ARCHIFY_PRIMARY}}]%F{\${ARCHIFY_PRIMARY}}-%F{\${ARCHIFY_PRIMARY}}[%B%F{\${ARCHIFY_SUCCESS}}%~%b%F{\${ARCHIFY_PRIMARY}}]%f \$(git_prompt_info)
